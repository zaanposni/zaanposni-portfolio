<div class="my-24 px-4 lg:px-0">
    <div class="container mx-auto mb-8"><h2 class="font-display font-bold text-6xl lg:text-8xl">Open Source</h2></div>
            ...
            <a
                ...
                ><div>
                    ...
                    <div class="mt-2 font-medium leading-normal">
                        <span class="text-red-500">1.560</span>
                        Downloads
                    </div>
                </div></a
            >
            <a
                href="https://github.com/zaanposni/vvspy"
                target="_blank"
                rel="noopener"
                class="w-full lg:w-1/2 px-6 my-4 border-l-4 border-white hover:border-red-500 transition duration-100"
                ><div>
                    ...
                    <div class="mt-2 font-medium leading-normal">
                        <span class="text-red-500">14.308</span>
                        Downloads
                    </div>
                </div></a
            >
